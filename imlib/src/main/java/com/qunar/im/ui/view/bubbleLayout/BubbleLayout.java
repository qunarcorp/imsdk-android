...
//        setPadding(0,0,0,0);
        setBubbleColor(ContextCompat.getColor(context,R.color.atom_ui_light_gray_f1));
    }

    public void resetBubble(boolean isReceive){
//        int padding = dp2px(context,4);
//        setPadding(padding,padding,padding,padding);
        setBubbleColor(ContextCompat.getColor(context,isReceive?R.color.atom_ui_white:R.color.atom_ui_laohe_green));
    }
