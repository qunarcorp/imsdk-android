...
//            adapter.setGravatarHandler(new MembersAdapter.GravatarHandler() {
//                @Override
//                public void requestGravatarEvent(final String userJid, final SimpleDraweeView view) {
//                    ProfileUtils.displayGravatarByUserId( QtalkStringUtils.parseBareJid(userJid),
//                            view);
//                }
//            });
...
//                    ProfileUtils.loadNickName(crm.getName(), false, new ProfileUtils.LoadNickNameCallback() {
//                        @Override
//                        public void finish(String s) {
//                            Intent returnIntent = new Intent();
//                            returnIntent.putExtra("atName",s);
//                            if(getParent()==null) {
//                                setResult(RESULT_OK,returnIntent);
//                            }
//                            else {
