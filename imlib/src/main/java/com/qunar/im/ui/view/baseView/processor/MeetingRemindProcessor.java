...
import com.qunar.im.base.jsonbean.MeetingDataBean;
import com.qunar.im.base.module.IMMessage;
import com.qunar.im.base.util.JsonUtils;
import com.qunar.im.protobuf.common.CurrentPreference;
import com.qunar.im.ui.activity.QunarWebActvity;
import com.qunar.im.ui.view.baseView.IMessageItem;
import com.qunar.im.ui.view.baseView.MeetingRemindView;
...
public class MeetingRemindProcessor extends DefaultMessageProcessor{
    ...
    public void processChatView(ViewGroup parent, final IMessageItem item) {
        ...
        try {
            MeetingDataBean meetingDataBean = JsonUtils.getGson().fromJson(message.getExt()
                    , MeetingDataBean.class);
            MeetingRemindView meetingRemindView = ViewPool.getView(MeetingRemindView.class, context);
