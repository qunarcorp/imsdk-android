...
//        });
    ...
    public String getMarkNames() {
        String name = IMDatabaseManager.getInstance().selectMarkupNames().get(myProfileView.getJid());
    ...
    public void updateMarkupName() {
        ...
        final Map<String,String> map = IMDatabaseManager.getInstance().selectMarkupNames();
