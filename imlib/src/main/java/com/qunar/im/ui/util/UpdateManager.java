...
//                if (Integer.valueOf(mUpdate.version) > curVersionCode) {
//                    CurrentPreference.getInstance().setIsShowVersion(true);
//                    CurrentPreference.getInstance().savePreference();
//                }else {
//                    CurrentPreference.getInstance().setIsShowVersion(false);
//                    CurrentPreference.getInstance().savePreference();
//                }
                //显示检测结果
                if (mUpdate != null) {
                    if (curVersionCode < mUpdate.version && (isForce || mUpdate.forceUpdate
