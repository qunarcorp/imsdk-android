...
//                                Logger.i(new Gson().toJson(nick));
                        ...
                        if (data.getConversationType() == 4) {
                            holder.mNameTextView.setText(TextUtils.isEmpty(nick.getName()) ? nick.getXmppId() : nick.getName());
                            ...
                            connectionUtil.getUserCard(data.getId(), new IMLogicManager.NickCallBack() {
                                ...
                                public void onNickCallBack(Nick nick1) {
                                    if (CommonConfig.isQtalk) {
                                        holder.mNameTextView.setText(nick1.getName() + "-" + nick.getName());
                                    } else {
                                        holder.mNameTextView.setText(nick.getName() + "-" + nick1.getName());
                                    }
...
//                        + "条]" + latestMsg;
//
//                holder.mNotifyTextView.setVisibility(View.INVISIBLE);
//            } else {
//
...
//            }
                ...
                //设置不提醒
//                holder.mNotifyTextView.setBackgroundResource(R.drawable.atom_ui_unread_circle_remind_bg);
