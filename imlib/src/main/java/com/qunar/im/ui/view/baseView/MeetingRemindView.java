...
public class MeetingRemindView extends LinearLayout {
    private TextView meetingTextView;
    private TextView click_to_detail;
    public MeetingRemindView(Context context) {
        this(context, null);
    }

    public MeetingRemindView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MeetingRemindView(Context context, AttributeSet attrs, int defStyleAttr) {
