...
//            TextView delete =
            ...
            delete.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    workWorldPresenter.deleteWorkWorldItem(item);
...
//
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bindData();
        initAdapter();
        workWorldPresenter.loadingHistory();
        workWorldPresenter.loadingNoticeCount();
    }
...
//        });
    ...
    private void bindView() {
        ...
        headViewLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
//                hiddenHeadView();
                Intent intent = new Intent(WorkWorldActivity.this, WorkWorldNoticeActivity.class);
...
//                Toast.makeText(WorkWorldActivity.this, "查看通知", Toast.LENGTH_LONG).show();
    ...
    private void refresh() {
        ...
        workWorldPresenter.startRefresh();
...
//        }).start();
    ...
    private void loadMore() {
        workWorldPresenter.loadingMore();
    }
...
//        mSwipeRefreshLayout.setRefreshing(true);//设置可开启
        ...
        if (TextUtils.isEmpty(searchUserIdstr)) {
            ...
            setActionBarRigthClick(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(WorkWorldActivity.this, ReleaseCircleActivity.class);
...
//                        datalist.addAll(list);
    ...
    @Override
    public void removeWorkWorldItem(final WorkWorldDeleteResponse worldDeleteResponse) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                for (int i = 0; i < workWorldAdapter.getData().size(); i++) {
    ...
    public boolean onContextItemSelected(MenuItem item) {
        try {
            ...
            switch (item.getItemId()) {
                //转发
                case delete:
                    workWorldPresenter.deleteWorkWorldItem(workWorldItem);
                    Toast.makeText(WorkWorldActivity.this, "删除", Toast.LENGTH_LONG).show();
...
//                startActivity(selUser);
    ...
    protected void onDestroy() {
        ...
        if (workWorldPresenter != null) {
            workWorldPresenter.removeEvent();
        }
    }
}
