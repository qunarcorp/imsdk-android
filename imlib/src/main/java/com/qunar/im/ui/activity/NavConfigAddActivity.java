...
public class NavConfigAddActivity extends SwipeBackActivity implements PermissionCallback {
    ...
    private TextView atom_ui_nav_config_add_scan;
    ...
    private void initView(){
        ...
        atom_ui_nav_config_add_scan = (TextView) findViewById(R.id.atom_ui_nav_config_add_scan);
        atom_ui_nav_config_add_scan.setOnClickListener(new View.OnClickListener() {
            @Override
