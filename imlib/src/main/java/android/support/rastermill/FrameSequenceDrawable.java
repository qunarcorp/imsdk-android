...
public class FrameSequenceDrawable extends Drawable implements Animatable, Runnable, MemoryCache.Cacheable {
    ...
    public static final Parcelable.Creator<FrameSequenceDrawable> CREATOR
            = new Parcelable.Creator<FrameSequenceDrawable>() {
        /**
         ...
         */
        public FrameSequenceDrawable createFromParcel(Parcel p) {
            FrameSequenceDrawable drawable = p.readParcelable(ClassLoader.getSystemClassLoader());
            if (drawable == null) {
                throw new RuntimeException("Failed to unparcel Bitmap");
            }
            return drawable;
        }
        public FrameSequenceDrawable[] newArray(int size) {
            return new FrameSequenceDrawable[size];
        }
    };
