...
public class ImageDataSource implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        ...
        if (id == LOADER_ALL){
            ...
            cursorLoader = new CursorLoader(activity, MediaStore.Images.Media.EXTERNAL_CONTENT_URI, IMAGE_PROJECTION, selector, selectionArgs, IMAGE_PROJECTION[6] + " DESC");
        }
        //扫描某个图片文件夹
...
//                }
            ...
            if (data.getCount() > 0 && allImages.size()>0) {
                ...
                allImagesFolder.name = activity.getResources().getString(R.string.atom_ui_ip_all_images);
