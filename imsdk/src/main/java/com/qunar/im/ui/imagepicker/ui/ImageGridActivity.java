...
import com.qunar.im.ui.imagepicker.view.FolderPopUpWindow;
 ...
 */
public class ImageGridActivity extends ImageBaseActivity implements ImageDataSource.OnImagesLoadedListener, ImageRecyclerAdapter.OnImageItemClickListener, ImagePicker.OnImageSelectedListener, View.OnClickListener, IMNotificaitonCenter.NotificationCenterDelegate {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.atom_ui_activity_image_grid);
...
//            intent.putExtra(ImagePicker.EXTRA_IMAGE_ITEMS, imagePicker.getCurrentImageFolderItems());
    ...
    public void onImageSelected(int position, ImageItem item, boolean isAdd) {
        if (imagePicker.getSelectImageCount() > 0) {
            ...
            mBtnPre.setText(getResources().getString(R.string.atom_ui_ip_preview_count, imagePicker.getSelectImageCount()));
            ...
            mBtnPre.setText(getResources().getString(R.string.atom_ui_ip_preview));
