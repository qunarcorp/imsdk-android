...
//                                context.startActivity(intent);
                                ConnectionUtil.getInstance().lanuchVideo(true,CurrentPreference.getInstance().getUserid(),tojid);
...
//                                context.startActivity(intent);
                                ConnectionUtil.getInstance().lanuchVideo(false,CurrentPreference.getInstance().getUserid(),tojid);
                                IMNotificaitonCenter.getInstance().postMainThreadNotificationName(QtalkEvent.NOTIFY_RTCMSG, isVideo);
//                        ((IP2pRTC) (IChatingPresenter) context).startVideoRtc();
                            }
                        }
