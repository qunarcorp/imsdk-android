package com.qunar.im.ui.util.easyVideo;
...
public class JzvdStd extends Jzvd {
    ...
    public LinearLayout shareAndDownLoadLayout;
    ...
    public void init(Context context) {
        ...
        downLoadButton = findViewById(R.id.down_load);
        shareButton = findViewById(R.id.share);
        shareAndDownLoadLayout = findViewById(R.id.share_and_download);
