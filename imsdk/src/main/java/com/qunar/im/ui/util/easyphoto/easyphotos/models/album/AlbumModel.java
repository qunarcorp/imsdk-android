package com.qunar.im.ui.util.easyphoto.easyphotos.models.album;
...
import com.qunar.im.ui.util.easyphoto.easyphotos.models.album.entity.Album;
import com.qunar.im.ui.util.easyphoto.easyphotos.models.album.entity.AlbumItem;
...
//            Log.d(TAG, "call: " + "Empty photos");
            ...
            do {
                ...
                try {
                    ...
                    Logger.i("出现图片无法识别异常:photo"+imageItem.toString());
                    continue;
                }
