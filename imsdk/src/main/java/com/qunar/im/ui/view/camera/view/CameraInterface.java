...
import com.qunar.im.ui.view.camera.utils.AngleUtil;
import com.qunar.im.ui.view.camera.utils.CameraParamUtil;
...
public class CameraInterface implements Camera.PreviewCallback {
    ...
    //视频质量
    private int mediaQuality = QCameraView.MEDIA_QUALITY_MIDDLE;
...
//        }
    ...
    private static Rect calculateTapArea(float x, float y, float coefficient, Context context) {
        ...
        int centerX = (int) (x / Utils.getScreenWidth(context) * 2000 - 1000);
        int centerY = (int) (y / Utils.getScreenHeight(context) * 2000 - 1000);
