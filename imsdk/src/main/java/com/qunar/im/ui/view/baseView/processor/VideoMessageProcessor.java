...
public class VideoMessageProcessor extends DefaultMessageProcessor {
    ...
    public void processChatView(ViewGroup parent, IMessageItem item) {
        ...
        if (videoClickListener == null) {
            videoClickListener = new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    String url = QtalkStringUtils.addFilePathDomain(result.FileUrl);
        ...
        if (TextUtils.isEmpty(result.ThumbUrl)) {
            ...
            firstFrameUri = Uri.parse(QtalkStringUtils.addFilePathDomain(result.ThumbUrl));
        }

        videoIcon.setVideoInfo(result.FileSize, result.Duration);
        int h = 0;
        int w = 0;
        try {
        ...
        int maxWidth = (int) (Utils.getScreenWidth(QunarIMApp.getContext()) * 0.5);
        int maxHeight = maxWidth * 16 / 9;
        ...
        videoIcon.setLayoutParams(new LinearLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, h));
