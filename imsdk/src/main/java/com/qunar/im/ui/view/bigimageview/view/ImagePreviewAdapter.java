...
import com.qunar.im.ui.view.bigimageview.tool.utility.image.ImageUtil;
import com.qunar.im.ui.view.bigimageview.tool.utility.ui.PhoneUtil;
...
import com.qunar.im.ui.view.bigimageview.view.helper.ImageSource;
...
public class ImagePreviewAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, final int position) {
        ...
        imageView.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                if (ImagePreview.getInstance().getBigImageLongClickListener() != null) {
                    return ImagePreview.getInstance().getBigImageLongClickListener().onLongClick(v, position,activity);
                }
                return false;
            }
        });
        ...
        if (cacheFile != null && cacheFile.exists()) {
            ...
            Glide.with(activity).load(url.startsWith("file://")?url:new MyGlideUrl(url)).downloadOnly(new SimpleFileTarget() {
                @Override
    ...
    private void loadGifImageSpec(final String imagePath, final SubsamplingScaleImageViewDragClose imageView,
        ...
        Glide.with(activity)
            ...
            .listener(new RequestListener<File, GifDrawable>() {
                @Override
                public boolean onException(Exception e, File model, Target<GifDrawable> target,
