...
public class QopenChatForNetSearch implements QChatSchemaService {
    public final static QopenChatForNetSearch instance = new QopenChatForNetSearch();
    ...
    public boolean startActivityAndNeedWating(final IMBaseActivity context, Map<String, String> map) {
        ...
        Intent intent = new Intent(context.getApplicationContext(), PbChatSearchResultActivity.class);
