...
/**
 * Created by hubo.hu on 2017/10/13.
 */
...
public class CHorizontalProgressBar extends View {
    ...
    public CHorizontalProgressBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public CHorizontalProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.CHorizontalProgressBar);
        max = a.getInteger(R.styleable.CHorizontalProgressBar_zpb_max, 100);
        progress = a.getInteger(R.styleable.CHorizontalProgressBar_zpb_progress, 0);
        bgColor = a.getColor(R.styleable.CHorizontalProgressBar_zpb_bg_color, 0xff3F51B5);
        progressColor = a.getColor(R.styleable.CHorizontalProgressBar_zpb_pb_color, 0xffFF4081);
        padding = a.getDimensionPixelSize(R.styleable.CHorizontalProgressBar_zpb_padding, 2);
        a.recycle();
    }
