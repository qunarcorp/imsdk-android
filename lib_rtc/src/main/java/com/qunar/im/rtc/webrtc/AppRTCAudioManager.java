...
public class AppRTCAudioManager {
  ...
  private class WiredHeadsetReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
      ...
      LogUtil.d(TAG, "WiredHeadsetReceiver.onReceive" + AppRTCUtils.getThreadInfo() + ": "
  ...
  private AppRTCAudioManager(Context context) {
    ...
    useSpeakerphone = context.getString(R.string.atom_rtc_pref_speakerphone_default);
    LogUtil.d(TAG, "useSpeakerphone: " + useSpeakerphone);
    ...
    LogUtil.d(TAG, "defaultAudioDevice: " + defaultAudioDevice);
  ...
  public void stop() {
    ...
    AppRTCUtils.checkIsOnMainThread(apprtcContext);
    if (amState != AudioManagerState.RUNNING) {
      LogUtil.e(TAG, "Trying to stop AudioManager in incorrect state: " + amState);
      return;
    }
    amState = AudioManagerState.UNINITIALIZED;
    ...
    LogUtil.d(TAG, "AudioManager stopped");
  }
  ...
  private void setAudioDeviceInternal(AudioDevice device) {
    LogUtil.d(TAG, "setAudioDeviceInternal(device=" + device + ")");
    ...
    switch (device) {
      ...
      case BLUETOOTH:
        ...
        break;
      default:
        LogUtil.e(TAG, "Invalid audio device selection");
        break;
    }
  ...
  public void setDefaultAudioDevice(AudioDevice defaultDevice) {
    ...
    switch (defaultDevice) {
      ...
      case EARPIECE:
        ...
        break;
      default:
        LogUtil.e(TAG, "Invalid default audio device selection");
        break;
    }
    LogUtil.d(TAG, "setDefaultAudioDevice(device=" + defaultAudioDevice + ")");
    updateAudioDeviceState();
  }
  ...
  public void selectAudioDevice(AudioDevice device) {
    ...
    if (!audioDevices.contains(device)) {
      LogUtil.e(TAG, "Can not select " + device + " from available " + audioDevices);
    }
  ...
  public void updateAudioDeviceState() {
    ...
    if (bluetoothManager.getState() == AppRTCBluetoothManager.State.HEADSET_AVAILABLE
        || bluetoothManager.getState() == AppRTCBluetoothManager.State.SCO_CONNECTING
        || bluetoothManager.getState() == AppRTCBluetoothManager.State.SCO_CONNECTED) {
      LogUtil.d(TAG, "Need BT audio: start=" + needBluetoothAudioStart + ", "
    ...
    if (newAudioDevice != selectedAudioDevice || audioDeviceSetUpdated) {
      ...
      LogUtil.d(TAG, "New device status: "
              + "available=" + audioDevices + ", "
    ...
    LogUtil.d(TAG, "--- updateAudioDeviceState done");
  }
}
