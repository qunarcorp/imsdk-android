...
public abstract class QPushMessageReceiver extends BroadcastReceiver {
    ...
    public final void onReceive(Context context, Intent intent) {
        if (intent != null) {
            ...
            try {
                QPushMessage message = (QPushMessage) intent.getSerializableExtra(MESSAGE);
     ...
     * 透传
     */
    public abstract void onReceivePassThroughMessage(Context context, QPushMessage message);

    /**
     * 通知栏消息点击
     */
    public abstract void onNotificationMessageClicked(Context context, QPushMessage message);
