...
public class ThirdPushMessageReceiver extends PushMessageReceiver {
    private static final String TAG = "ThirdPushMessageReceiver";
    ...
    public void onReceivePassThroughMessage(Context context, MiPushMessage message) {
        ...
        if (ThirdPushManager.sQMessageProvider == null) {
            return;
        }
        String content = message.getContent();
        QPushMessage qPushMessage = new QPushMessage();
        qPushMessage.setPlatform(ThirdPushManager.NAME);
        ...
        ThirdPushManager.sQMessageProvider.onReceivePassThroughMessage(context, qPushMessage);
    }
    ...
    public void onNotificationMessageClicked(Context context, MiPushMessage message) {
        ...
        qPushMessage.setAlias(message.getAlias());
        qPushMessage.setPassThrough(message.getPassThrough());
        ThirdPushManager.sQMessageProvider.onNotificationMessageClicked(context, qPushMessage);
    }
    ...
    public void onNotificationMessageArrived(Context context, MiPushMessage message) {
        ...
        qPushMessage.setAlias(message.getAlias());
        qPushMessage.setPassThrough(message.getPassThrough());
        ThirdPushManager.sQMessageProvider.onNotificationMessageArrived(context, qPushMessage);
